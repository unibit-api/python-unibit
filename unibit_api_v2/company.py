...
class CompanyInfo(ub):
	...
	def getCompanyFinancials(self, ticker, interval, statement, startDate, endDate, selectedFields = "all", datatype='json'):
		...
		return self.make_request(endpoints=endpoints, data={'tickers': ticker, 'statement':statement, 'startDate': startDate, 'endDate': endDate, 'interval':interval, 'datatype':datatype})
	...
	def getOwnershipStructure(self, ticker, ownershipType, startDate, endDate, selectedFields = "all", datatype = "json"):
		...
		return self.make_request(endpoints=endpoints, data={'tickers': ticker, 'ownershipType':ownershipType, 'startDate': startDate, 'endDate': endDate, 'datatype': datatype})
	...
	def getInsiderTransactions(self, ticker, startDate, endDate, selectedFields="all", datatype='json', size=None):
		...
		return self.make_request(endpoints=endpoints, data={'tickers': ticker, 'startDate': startDate, 'endDate': endDate, 'datatype':datatype ,'size':size})
